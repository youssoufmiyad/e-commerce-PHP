...
<body>
    <form method="post">
        ...
        <select name="form-adress-country" id="form-adress-country">
            <option value="DE" <?php if ($_GET["form-adress-country"] === "DE") echo "selected"?>>Allemagne</option>
            <option value="BE" <?php if ($_GET["form-adress-country"] === "BE") echo "selected"?>>Belgique</option>
            <option value="HR" <?php if ($_GET["form-adress-country"] === "HR") echo "selected"?>>Croatie</option>
            <option value="DK" <?php if ($_GET["form-adress-country"] === "DK") echo "selected"?>>Danemark</option>
            <option value="ES" <?php if ($_GET["form-adress-country"] === "ES") echo "selected"?>>Espagne</option>
            <option value="FR" <?php if ($_GET["form-adress-country"] === "FR") echo "selected"?>>France</option>
            <option value="GR" <?php if ($_GET["form-adress-country"] === "GR") echo "selected"?>>Greece</option>
            <option value="UK" <?php if ($_GET["form-adress-country"] === "UK") echo "selected"?>>Royaume Uni</option>
        </select><br>
